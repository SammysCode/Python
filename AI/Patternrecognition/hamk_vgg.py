...
for images in os.listdir(img_path):
    ...
    cv2.putText(disp_img, actual_prediction[0][0][1], (20,20), cv2.FONT_HERSHEY_TRIPLEX, 0.8, (0,255,0))

    cv2.imwrite('vgg-img/VGG-'+images+'.jpg', disp_img)

data = {'Prediction': pred_obj, 'Accuracy': percent1 }
df = pd.DataFrame(data)
df.to_excel('vgg_result.xlsx')
